...
import ImageSlide from './ImageSlide1';
import RelatedProducts from './RelatedProducts1';
import Description from './Description';
import CarDetails from '../datas/fleet.json';
  ...
  render() {
    ...
    return (
      <section className="shop-details-area ptb-100">
        <div className="container">
          <div className="shop-details">
            <div className="row h-100 justify-content-center align-items-center">
              <ImageSlide image={CarDetails[this.props.props.index].image} />

              <div className="col-lg-7 col-md-12">
                <div className="product-entry-summary">
                  <h3>{CarDetails[this.props.props.index].title}</h3>
                  {/* <h4>
        ...
        <RelatedProducts props={this.props.props.index} />
      </section>
    );
  }
}
